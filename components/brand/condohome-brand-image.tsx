...
function CondHubMark({ theme }: { theme: MarkTheme }) {
  ...
  return (
    <svg viewBox="0 0 128 128" className="h-full w-auto" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M88 30H60c-18.225 0-33 14.775-33 33s14.775 33 33 33h28c7.18 0 13-5.82 13-13V43c0-7.18-5.82-13-13-13Z"
        fill="url(#condhub-body-gradient)"
        fillOpacity="0.94"
      />
      <path
      ...
      />
      <defs>
        <linearGradient id="condhub-body-gradient" x1="34" y1="34" x2="104" y2="98" gradientUnits="userSpaceOnUse">
...
function CondHubMarkResponsive() {
  return (
    <>
      <div className="block h-full dark:hidden" aria-hidden="true">
        <CondHubMark theme="light" />
      </div>
      <div className="hidden h-full dark:block" aria-hidden="true">
