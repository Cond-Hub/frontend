              ...
              spaces.map((space) => (
                <div key={space.id} className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-950">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    ...
                    <Button variant="outline" size="sm" className="gap-2 text-rose-700 dark:text-rose-300" onClick={() => setSpaceToRemove(space)}>
            ...
            {loading ? (
              ...
              upcomingReservations.map((reservation) => (
                <div key={reservation.id} className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-800 dark:bg-slate-950">
                  ...
                  <div className="mt-4">
                    <Button variant="outline" size="sm" className="gap-2 text-rose-700 dark:text-rose-300" onClick={() => setReservationToRemove(reservation)}>
                      <Trash2 className="h-4 w-4" />
                      Remover reserva
                    </Button>
                  </div>
